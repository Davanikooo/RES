...
#if defined(RES_CONFIG_DISABLE_WSTRICT) && (RES_CONFIG_DISABLE_WSTRICT + 0 == 0)
#if defined(RES_CONFIG_DISABLE_WERROR) && (RES_CONFIG_DISABLE_WERROR + 0 == 0)
#if (ACC_CC_MSC)
...
#endif
#endif // RES_CONFIG_DISABLE_WERROR
#endif // RES_CONFIG_DISABLE_WSTRICT
