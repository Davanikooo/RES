...
void show_license(void) {
    ...
    con_fprintf(f,
        ...
        "   but WITHOUT ANY WARRANTY; without even the implied warranty of\n"
        "   MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the\n"
        "   Resize License Agreements for more details.\n"
        "\n"
        "   You should have received a copy of the Resize License Agreements\n"
...
#endif
    // clang-format off
    fprintf(f, "Copyright (C) 2025 WHO-AM-I-404\n");
    fprintf(f, "Based on UPX - Ultimate Packer for eXecutables\n");
...
#endif
    // clang-format on
    fprintf(f, "Resize comes with ABSOLUTELY NO WARRANTY; for details type '%s -L'.\n", progname);
}
...
#endif
#if defined(RES_CONFIG_DISABLE_WSTRICT)
        cf_print("RES_CONFIG_DISABLE_WSTRICT", "%lld", RES_CONFIG_DISABLE_WSTRICT + 0, 3);
#endif
#if defined(RES_CONFIG_DISABLE_WERROR)
        cf_print("RES_CONFIG_DISABLE_WERROR", "%lld", RES_CONFIG_DISABLE_WERROR + 0, 3);
#endif
